<script lang="ts">
  ...
  } from "../../lib/flavor-assignment-helpers";
  ...
  <div class="grid gap-4 md:grid-cols-[1fr_auto_1fr] items-start">
    ...
    >
      <button
        ...
        disabled={busy || actionBusy || selectedAvailableFlavorIds.length === 0}
      >
        &gt;&gt;
      </button>
      ...
      <button
        ...
        disabled={busy || actionBusy || selectedAssignedFlavorIds.length === 0}
      >
        &lt;&lt;
      </button>
    </section>
