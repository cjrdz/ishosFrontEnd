  ...
  <div class="card-body p-4 sm:p-6 text-sm">
    <div class="flex flex-wrap items-center justify-between gap-2">
      <div class="flex flex-wrap items-center gap-2">
        ...
        >
          <Icon icon={tokenCopied === "both" ? "lucide:check" : "lucide:copy"} width="14" height="14" />
    ...
    <div class="grid gap-3 md:grid-cols-[1fr_1fr_0.9fr] text-sm">
      ...
      <div class="space-y-2">
        ...
        <p><strong>Creada por:</strong> {createdByLabel(selectedOrder, employeeById)}</p>
      </div>
      <div class="space-y-2">
            ...
            <div class="flex justify-end">
              <div class="flex items-center gap-2">
                ...
                {#if selectedOrder.status === "recibida" && isAdmin}
                  <button class="btn btn-xs btn-soft btn-error" onclick={() => onOpenReject(selectedOrder.id)}>
                    Rechazar
                  </button>
                {/if}
              </div>
