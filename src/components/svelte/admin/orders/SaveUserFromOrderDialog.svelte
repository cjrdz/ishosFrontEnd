  ...
  <div class="modal-box max-w-2xl">
    ...
    <form class="mt-4 space-y-4" onsubmit={onSubmit}>
      <div class="grid md:grid-cols-2 gap-4">
        ...
        <div class="form-control">
          <span id="save-user-type-label" class="label-text mb-1"
        ...
        <div class="form-control">
          <span id="save-user-phone-label" class="label-text mb-1"
            >Telefono</span
          >
          <input
            id="save-user-phone"
        ...
        <div class="form-control">
          <span id="save-user-email-label" class="label-text mb-1"
